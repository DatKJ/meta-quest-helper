...
- 大陆首次激活网络方案，包括 UU 加速器、手机热点、路由器 Wi-Fi、SSTap 全局 UDP 热点等。
- 开发者模式、未知来源、SideQuest、Quest 助手、MQDH、中文语音输入法和 Quest 端代理客户端。
...
本 Skill 不协助盗版、破解付费游戏、绕过 DRM、购买或租借黑产账号、篡改支付地区、硬改设备或规避平台风控。

涉及网络、代理、VPN、路由器分流和跨境连接时，应提醒用户遵守所在地法律法规、服务条款、单位/学校网络规定和 Meta 平台政策。本 Skill 不推荐具体节点商、黑产服务或承诺规避审查的服务。
